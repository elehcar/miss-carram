...
class ObstacleAvoidance(object):
    ...
    def calc_speed(self):
        ...
        if 100 < self.distanza_ostacolo <= 200:  # ostacolo non visibile o troppo lontano
            ...
            print("{OBSTACLE_AVOIDANCE + CAMERA} Linear: " + str(speed.linear.x) + ", Angular: " + str(speed.angular.z)
                  + ", Distanza: " + str(self.distanza_ostacolo) + ", Target: " + str(self.target_x))
        self.pub.publish(speed)


if __name__ == '__main__':
    rospy.init_node('obstacle_avoidance', anonymous=True)
    obstacle_avoidance = ObstacleAvoidance(0.1, 0.26)
